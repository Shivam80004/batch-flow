...
export default function LandingPage() {
  return (
    <div className="bg-zinc-950 min-h-screen text-zinc-50 font-sans overflow-x-hidden selection:bg-indigo-500/30">
      {/* Background Ambience */}
      <div className="absolute top-0 left-0 w-full h-[800px] overflow-hidden -z-10">
        <div className="absolute top-[-20%] left-[-10%] w-[50vw] h-[50vh] bg-indigo-600/15 blur-[150px] rounded-full animate-float"></div>
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-zinc-950/50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-indigo-500/10 border border-indigo-500/30 flex items-center justify-center glow-indigo">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/register" className="h-10 px-5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-full text-sm font-semibold flex items-center gap-2 transition-all glow-indigo">
      ...
      <section className="relative pt-44 pb-32 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        <div className="mb-6 inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-indigo-300 text-xs font-semibold tracking-widest uppercase animate-fade-in">
          <span className="w-2 h-2 rounded-full bg-indigo-400 animate-pulse glow-indigo"></span>
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter mb-8 leading-[1.1] text-transparent bg-clip-text bg-gradient-to-br from-white via-white/90 to-zinc-500">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-emerald-400 glow-text-indigo">At Light Speed</span>
        </h1>
        ...
        <div className="w-full mt-24 relative perspective-1000">
           ...
           <div className="w-full h-[600px] glass-panel rounded-[32px] md:rounded-[48px] border border-white/10 overflow-hidden relative shadow-[0_0_100px_rgba(79,70,229,0.2)] transform rotate-x-[5deg] scale-[0.95] hover:scale-100 transition-transform duration-1000 ease-out">
              {/* Mock UI Header */}
      ...
      <section id="features" className="py-32 px-6 bg-zinc-950">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Big Feature */}
            <div className="md:col-span-2 glass-panel p-8 md:p-12 rounded-[32px] group relative overflow-hidden border border-white/5 hover:border-indigo-500/30 transition-colors">
              <div className="absolute top-0 right-[-10%] w-96 h-96 bg-indigo-600/10 blur-[100px] group-hover:bg-indigo-600/20 transition-colors"></div>
              <LayoutDashboard className="w-12 h-12 text-indigo-400 mb-8" />
            ...
            <div className="md:col-span-2 glass-panel p-8 md:p-12 rounded-[32px] group relative overflow-hidden border border-white/5 hover:border-indigo-500/30 transition-colors flex flex-col justify-end min-h-[300px]">
              <div className="absolute inset-x-0 bottom-0 h-64 bg-gradient-to-t from-indigo-900/20 blur-[50px] group-hover:from-indigo-900/30 transition-colors"></div>
      ...
      <section id="use-cases" className="py-32 px-6 border-t border-white/5 border-b relative">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
           ...
           <div className="flex-1 w-full glass-panel rounded-[40px] p-8 border border-white/10 relative overflow-hidden h-[500px] flex items-center justify-center">
              ...
              <div className="w-48 h-48 rounded-full border border-indigo-500/20 absolute flex items-center justify-center animate-[spin_10s_linear_infinite]">
                 <div className="w-full h-full rounded-full border border-dashed border-indigo-500/50"></div>
                 <div className="w-3 h-3 bg-indigo-400 rounded-full glow-indigo absolute top-[-6px]"></div>
              </div>
              <div className="w-24 h-24 rounded-full bg-zinc-950 border border-white/10 flex items-center justify-center z-10 shadow-2xl shadow-indigo-500/20">
      ...
      <footer className="py-32 px-6 flex flex-col items-center text-center relative overflow-hidden">
        <div className="absolute inset-0 top-1/2 bg-indigo-900/10 blur-[100px] -z-10 rounded-t-[100%]"></div>
        ...
        <Link href="/register" className="h-16 px-10 bg-indigo-600 hover:bg-indigo-500 text-white rounded-full text-lg font-bold flex items-center gap-3 transition-all glow-indigo hover:scale-105">
